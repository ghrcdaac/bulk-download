class DownloadManager{
    ...
    download(downloadItem){
        ...
        try {
            ...
            x.open("GET", downloadItem.url, true);
            ...
            x.onload = (e) => {
                ...
                const headers = [{
                    name: `Authentication`,
                    value: `Bearer ${secret},Basic ${token}`
                }]

                console.log(e.target.status, e.target.responseURL);

                if(e.target.status == 302){
                    downloadItem.url = e.target.responseURL;
                }
